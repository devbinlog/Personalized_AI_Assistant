...
export function StatsGrid({ stats }: StatsGridProps) {
  const items = [
    { label: '대화 수', value: stats.totalConversations, icon: MessageSquare, iconCls: 'text-slate-600' },
    { label: '선호도 로그', value: stats.totalPreferenceLogs, icon: Layers, iconCls: 'text-emerald-500' },
    { label: '메모리 버전', value: `v${stats.memoryVersion}`, icon: Brain, iconCls: 'text-slate-600' },
